<template>
    <div class="modal fade" id="createManagerForm">
...
<script>
    ...
    export default {
        setup() {
            ...
            const emptyManager = {...store.getters.getManagerModel};
            ...
            async function storeManager() {
                try {
                    ...
                    let storedManager = await container.ManagerService.store(manager);
                    store.commit('manager/setUserById', storedManager.data.model);
