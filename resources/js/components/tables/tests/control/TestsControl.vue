<template>
    <div class="d-flex mb-3 mt-2">
        ...
        <button class="btn btn-primary btn ml-2" data-toggle="modal"
                ...
                data-target="#addTestForm">Add test
        </button>
...
export default {
    setup() {
        ...
        async function getCompanies() {
            ...
            await store.dispatch('test/setTestsToStore', filters);
        }
        ...
        return {
            ...
            managers: computed(() => store.getters.getUsers),
            ...
            refresh: () => store.dispatch('test/setTestsToStore')
        }
    }
};
</script>
