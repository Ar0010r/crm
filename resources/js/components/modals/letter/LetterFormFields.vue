    ...
    <div class="form-row mb-2 d-flex flex-column">
        <div v-if="profile.role === 'admin'" id="letterHrField" class="form-row mb-2 d-flex flex-column">
            <div class="form-group col mb-0 d-flex align-items-center justify-content-between flex-wrap">
                ...
                <select class="custom-select form-control form-control-sm col-md-10"
                        ...
                        @blur="hr.handleBlur"
                        :class="{'is-invalid': !hr.meta.valid && hr.meta.touched}"
                >
        ...
        <div class="form-row mb-2 d-flex flex-column">
            <div class="form-group col mb-0 d-flex align-items-center justify-content-between flex-wrap">
                ...
                >
                <small class=" col-md-12 invalid-feedback text-right p-0">{{errors.google || 'google is required'}}</small>
            </div>
        </div>
        <div class="form-row mb-2 d-flex flex-column">
            <div class="form-group col mb-0 d-flex align-items-center justify-content-between flex-wrap">
                ...
                >
                <small class=" col-md-12 invalid-feedback text-right p-0">{{errors.yahoo || 'yahoo is required'}}</small>
            </div>
        </div>
        <div class="form-row mb-2 d-flex flex-column">
            <div class="form-group col mb-0 d-flex align-items-center justify-content-between flex-wrap">
                ...
                >
                <small class=" col-md-12 invalid-feedback text-right p-0">{{errors.outlook || 'outlook is required'}}</small>
            </div>
        </div>
        <div class="form-row mb-2 d-flex flex-column">
            <div class="form-group col mb-0 d-flex align-items-center justify-content-between flex-wrap">
                ...
                >
                <small class=" col-md-12 invalid-feedback text-right p-0">{{errors.other || 'other is required'}}</small>
            </div>
        </div>
        <div class="form-row mb-2 d-flex flex-column">
            <div class="form-group col mb-0 d-flex align-items-center justify-content-between flex-wrap">
                ...
                >
                <small class=" col-md-12 invalid-feedback text-right p-0">{{errors.received_at || 'received_at is required'}}</small>
            </div>
        </div>
    </div>
</template>
...
<script>
    ...
    export default {
        setup(props) {
            ...
            const hr = useField('hr_id', {value: computed(() => props.letter.hr_id)});
            ...
            return {
                ...
                google, yahoo, outlook, other, received, hr,
