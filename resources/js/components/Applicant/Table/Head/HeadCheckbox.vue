...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            emitter.on('applicant-unselected', reduceItem);
            onBeforeUnmount(() => emitter.off('applicant-unselected', reduceItem));
            ...
            function disable() {
                ...
                emitter.emit('unselect-all-applicants')
            }
