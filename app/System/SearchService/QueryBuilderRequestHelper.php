...
class QueryBuilderRequestHelper
{
    ...
    public function getQueryBuilderRequest(): QueryBuilderRequestHelper
    {
    ...
    private function setQueryBuilderRequestData(): QueryBuilderRequestHelper
    {
    ...
    private function setQueryBuilderRequestWrapper(): QueryBuilderRequestHelper
    {
        ...
        $this->queryBuilderRequest = $this->queryBuilderRequest->merge([
            ...
            '_public_scope' => $this->httpRequest->input('_public_scope', false),
        ]);

        return $this;
    }

    private function prepareRequestData(): QueryBuilderRequestHelper
    {
    ...
    private function transformPluralKeys(): QueryBuilderRequestHelper
    {
    ...
    private function transformIdsToString(): QueryBuilderRequestHelper
    {
    ...
    private function setCorrectKeyForRelatedValues(): QueryBuilderRequestHelper
    {
        $filters = [];
        foreach ($this->requestData as $key => $filter) {
